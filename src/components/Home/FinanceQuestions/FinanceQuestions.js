      ...
      <div className={styles.container2}>
                  ...
                  <div>
                    ...
                    {item?.points &&
                      item?.points?.map((ele, ind) => (
                        <p key={ind} className={styles.serviceDescription}>
                          {ele.point}
                        </p>
                      ))}
                  </div>
        ...
        <div className={styles.headsection2}>
          ...
          <p className={styles.description}>
            Fixed Fee ₹15,000 for the first year, ₹5,000 renewal annually
            thereafter
          </p>
        </div>
      </div>
